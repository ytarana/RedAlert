...
public class nearestPoliceStation extends FragmentActivity implements LocationListener {
    ...
    void requestLocationPermission() {
        ...
        int permissionCheck = ContextCompat.checkSelfPermission(nearestPoliceStation.this, android.Manifest.permission.ACCESS_FINE_LOCATION);
        if ((permissionCheck == PackageManager.PERMISSION_GRANTED)) {
            ...
            ActivityCompat.requestPermissions(nearestPoliceStation.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 42);
